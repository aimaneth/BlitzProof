    ...
    <section className="py-16 px-4 bg-black/20">
      <div className="mx-auto max-w-6xl">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold mb-6 text-foreground">Supported Networks</h2>
        ...
        <div className="relative overflow-hidden">
          {/* Left fade gradient */}
          <div className="absolute left-0 top-0 w-48 h-full bg-gradient-to-r from-black via-black/90 to-transparent z-10 pointer-events-none"></div>
          
          {/* Right fade gradient */}
          <div className="absolute right-0 top-0 w-48 h-full bg-gradient-to-l from-black via-black/90 to-transparent z-10 pointer-events-none"></div>
